  ...
  <p class="txt_section">닫기 버튼 효과는 다른 레이어 팝업에도 적용이 가능합니다.</p>
    <ul class="list_pages">
      <li>
        ...
        <a href="https://codepen.io/run-hani/pen/zydVxP" target="_blank" class="link_code">CODE</a>
      </li>
      <li>
        ...
        <a href="https://codepen.io/run-hani/pen/yGodJM" target="_blank" class="link_code">CODE</a>
      </li>
      <li>
        ...
        <a href="https://codepen.io/run-hani/pen/ZVJgBm" target="_blank" class="link_code">CODE</a>
      </li>
      <li>
        ...
        <a href="https://codepen.io/run-hani/pen/OrjKWg" target="_blank" class="link_code">CODE</a>
      </li>
      <li>
        ...
        <a href="https://codepen.io/run-hani/pen/yGomMx" target="_blank" class="link_code">CODE</a>
      </li>
    </ul>
